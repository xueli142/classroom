  ...
  function onCourseSelected(list) {
    ...
    form.value.courseId=raw.courseId,
        form.value.courseName=raw.courseName,
        form.value.bookingNumber=raw.number,
        form.value.teacherId=raw.userId,
        form.value.imageUrl=raw.imageUrl,
        form.value.userId=raw.userId,
        form.value.teacherName=raw.teacherName,
        form.value.status=raw.status
